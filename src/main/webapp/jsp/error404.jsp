...
<div id="appearance-error">
    <div class="jumbotron">
        <h1 id="error-title">
            <br><fmt:message key="error404.title"/></h1>
        <p id="error-name">
            <br><fmt:message key="error404.name"/><br>
            <br>
        </p>
        <p>
            <a class="btn btn-primary text-uppercase" role="button" href="${pageContext.request.contextPath}controller?commandName=home_page">
