...
<div class="container site-section" id="welcome">
    <h1><fmt:message key="middle_workout.title"/></h1>
...
<div class="container site-section" id="images">
        <img align="center" src="${pageContext.request.contextPath}/img/middle1.jpg" height="250px">
        <img align="center" src="${pageContext.request.contextPath}/img/middle2.jpg" height="250px">
</div>
