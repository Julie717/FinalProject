...
/**
 * The type Low workout page command.
 * This command allows to go to the page with workouts of low level
 *
 * @author Buyalskaya Yuliya
 * @version 1.0
 */
public class LowWorkoutPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            ...
            List<Workout> workouts = workoutService.findByLevel(Workout.Level.LOW);
            request.setAttribute(AttributeName.WORKOUTS_LOW, workouts);
            page = ConfigurationManager.getProperty(PageConfigName.LOW_WORKOUT_PAGE);
