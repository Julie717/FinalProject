...
public class InstructorsPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            ...
            instructors = userService.findAllInstructors();
            request.setAttribute(AttributeName.INSTRUCTORS, instructors);
            page = ConfigurationManager.getProperty(PageConfigName.INSTRUCTORS);
